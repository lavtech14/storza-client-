// components/SalesReport/ReportSummary.tsx
...
export const ReportSummary = ({ report }: ReportSummaryProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Chart Section (if chart data is available) */}
                    ...
                    <div className="relative pt-1">
                      ...
                      <div className="overflow-hidden h-2 text-xs flex rounded bg-indigo-200 dark:bg-indigo-900">
                        <div
                          style={{
                            width: `${Math.min(
                              (item.total / report.summary.totalSales) * 100,
                              100,
                            )}%`,
                          }}
          ...
          <p className="text-lg font-semibold text-gray-700 dark:text-gray-300">
            {formatCurrency(
              report.summary.totalOrders > 0
                ? report.summary.totalSales / report.summary.totalOrders
                : 0,
            )}
          </p>
        </div>
