...
function PurchasePage() {
  ...
  useEffect(() => {
    ...
    socket.on("purchaseUpdated", fetchPurchases);
    socket.on("purchaseDeleted", fetchPurchases);

    return () => {
      socket.off("purchaseCreated", fetchPurchases);
      socket.off("purchaseUpdated", fetchPurchases);
      socket.off("purchaseDeleted", fetchPurchases);
    };
  }, [page, debouncedSearch]);
